...
* [VirtualBox - 仮想ディスク（.vdi）のサイズ（容量）変更](https://pc-karuma.net/virtualbox-resize-vm-disk/)
...
* rpmをyumでインストール
  ...
  ```
  $sudo rpm -ivh VirtualBox-5.2-5.2.8_121009_el7-1.x86_64.rpm 
  警告: VirtualBox-5.2-5.2.8_121009_el7-1.x86_64.rpm: ヘッダー V4 DSA/SHA1 Signature、鍵 ID 98ab5139: NOKEY
  準備しています...              ################################# [100%]
  更新中 / インストール中...
     1:VirtualBox-5.2-5.2.8_121009_el7-1################################# [100%]
